...
class Model: 
    def __init__(self, img_width=200, img_height=200, color_mode=1):
    ...
    def get_model(self): 
        ...
        x = Conv2D(32, (3, 3), padding='same')(pool_1)
        x = BatchNormalization()(x)
        x = Activation('relu')(x)
        ...
        x = Conv2D(64, (3, 3), padding='same')(pool_2)
        x = BatchNormalization()(x)
        x = Activation('relu')(x)
        ...
        x = Conv2D(128, (3, 3), padding='same')(pool_3)
        x = BatchNormalization()(x)
        x = Activation('relu')(x)
        ...
        x = Conv2D(256, (3, 3), padding='same')(pool_4)
        x = BatchNormalization()(x)
        x = Activation('relu')(x)
