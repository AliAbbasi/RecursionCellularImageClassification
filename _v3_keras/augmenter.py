...
def translate_down(x):
    ...
    for random_channel in random_channel_s:
        ...
        random_trans_value = random.randint(2,4)
...
def apply_augmentation(x): 
    ...
    augmentation_functions = [salt_and_pepper, blur, rotate_90, rotate_180, rotate_270, flip_up, flip_right, 
                              remove_some_part, no_aug,translate_down, 
                              translate_left, translate_right, translate_up]
                              
    # augmentation_functions = [salt_and_pepper, blur, rotate_90, rotate_180, rotate_270, flip_up, flip_right, 
                              # remove_some_part, no_aug,translate_down, 
                              # translate_left, translate_right, translate_up, brightness, poisson]
