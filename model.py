...
class Model: 
    ...
    def parameters(self):
        ...
        w8   = [3, 3, w1[3]+w2[3]+w5[3],                32     ]
        w9   = [1, 1, w8[3],                            w8[3]  ]
        w10  = [3, 3, w8[3],                            w8[3]  ]
        
        w11  = [3, 3, w1[3]+w2[3]+w5[3]+w8[3],          64     ]
        w12  = [1, 1, w11[3],                           w11[3] ]
        w13  = [3, 3, w11[3],                           w11[3] ]
        
        w14  = [3, 3, w1[3]+w2[3]+w5[3]+w8[3]+w11[3],   128    ]
        w15  = [1, 1, w14[3],                           w14[3] ]
        w16  = [3, 3, w14[3],                           w14[3] ]
        
        # wFC  = [8*8*(w1[3]+w2[3]+w5[3]+w8[3]+w11[3]+w14[3]), 256]  # 256
        wFC  = [4*4*(w1[3]+w2[3]+w5[3]+w8[3]+w11[3]+w14[3]), 256]  # 128
        # wFC  = [2*2*(w1[3]+w2[3]+w5[3]+w8[3]+w11[3]+w14[3]), 256]  # 64
        wOut = [wFC[1], 1108]
